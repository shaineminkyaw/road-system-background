...
type type5Controller struct {
	H *Handler
}

func NewType5Controller(h *Handler) *type5Controller {
	return &type5Controller{
		H: h,
	}
}
...
//type5 response
type RespTableType5List struct {
...
//type5 list
func (ctr *type5Controller) list(c *gin.Context) {
	//
	resp := &dto.RespObj{}
	req := ReqTableType5List{}
	...
	betResp := make([]*RespTableType5List, 0)
	...
	for _, bet := range bets {
		betResp = append(betResp, &RespTableType5List{
...
//type5 create request
type ReqType5Create struct {
	RoadType    int8   `json:"road_type" form:"road_type" binding:"required"`
...
// type5 create
func (ctr *type5Controller) create(c *gin.Context) {
	//
...
//type5 edit
func (ctr *type5Controller) edit(c *gin.Context) {
	//
...
//delete request for type5
type ReqDeleteType5 struct {
	RoadType uint64 `json:"road_type"`
	ID       uint64 `json:"tid"`
}

//type5 delete
func (ctr *type5Controller) erase(c *gin.Context) {
	//
